...
curl "http://localhost:4741/dives//$ID" \
  --include \
  --request PATCH \
...
echo
# ID=1 user_id=1 location="Pirate's cove"  date="2018-2-3" max_depth=60 duration=30 psi_used=2000 weight_used=10 rating=4 notes="nice" make_public=1 sh scripts/dives/update-dive.sh
